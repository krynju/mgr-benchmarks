...
type = [
    "increment_map", "filter_half", "reduce_var_all", "reduce_var_single",
    "groupby_single_col", "grouped_reduce_mean_singlecol", "grouped_reduce_mean_allcols", "innerjoin_r_unique",
    "scenario_table_load", "scenario_full_table_statistics", "scenario_count_unique_a1", "scenario_rowwise_sum_and_mean_reduce", "scenario_grouped_a1_statistics"
]

basic_types = ["increment_map", "filter_half", "reduce_var_all", "reduce_var_single"]
